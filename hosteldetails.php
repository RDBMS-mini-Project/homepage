...
else 
{
    ...
    $query2="SELECT * FROM owner_reg WHERE owner_id=$owner";
  ...
  <div class="container-md">
    ...
    <div class="card my-4 shadow">
        <div class="card-body text-center">
            ...
            <p class="text-muted mb-4">Address:<?php echo $address; ?></p>
            <p class="text-muted mb-4">Contact No:<?php echo $contact; ?></p>
            <p class="text-muted mb-4">Distance From Collage:</Address><?php echo $distance; ?>km</p>
        </div>
    </div>
</div>
